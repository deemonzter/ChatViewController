...
@property (nonatomic, retain) SLKTextViewControllerConfiguration * _Nullable currentConfiguration;
...
- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
    return [self initWithTableViewStyle:UITableViewStylePlain andConfiguration:nil];
}
...
- (instancetype)initWithTableViewStyle:(UITableViewStyle)style
                      andConfiguration:(SLKTextViewControllerConfiguration *)configuration {
