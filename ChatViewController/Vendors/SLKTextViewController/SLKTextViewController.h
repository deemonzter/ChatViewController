...
#import "SLKTextViewControllerConfiguration.h"
...
/**
 ...
 @param configuration A constant for adding most if not all of the possible customization for this controller and its textInputBar.
...
- (instancetype __nullable)initWithTableViewStyle:(UITableViewStyle)style
                                 andConfiguration:(SLKTextViewControllerConfiguration * _Nullable)configuration;
